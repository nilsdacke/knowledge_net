...
class LangchainChatModel(ChatModel):
    ...
    def chat_history_to_langchain_question(chat_history: ChatHistory) -> dict[str, Any]:
        ...
        langchain_messages = LangchainChatModel.chat_history_to_langchain_messages(chat_history)
    ...
    def chat_history_to_langchain_messages(chat_history: ChatHistory) -> list[BaseMessage]:
        ...
        return [LangchainChatModel.message_event_to_langchain(m) for m in chat_history.get_messages()]
